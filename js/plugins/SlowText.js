...
//=============================================================================
    ...
    Window_Message.prototype.updateWait = function() {
      if (this._waitCount > 0 && !this._showFast) {
          ...
          if(textState && textState._translateEffect) {
              if(textState._hasParrot && this._waitCount % 5 == 0) {
                this.processTranslatedCharacter(textState);
                textState._pastCharacters.push(null);
              }
          }
          this._waitCount--;
          return true;
